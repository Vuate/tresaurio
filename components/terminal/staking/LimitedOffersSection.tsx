...
export default function LimitedOffersSection() {
  return (
    <section className="space-y-5">
      ...
      {/* Responsive grid - sidebar değişimlerine uyumlu */}
...
function OfferCard() {
  return (
    <div className="rounded-xl border border-white/10 bg-white/5 p-5 space-y-4 min-w-0">
      <div className="flex justify-between items-start gap-3">
        <div className="flex gap-3 min-w-0 flex-1">
          <div className="w-10 h-10 shrink-0 rounded-full bg-gradient-to-br from-teal-300 to-teal-600 flex items-center justify-center text-lg">
            💰
          </div>
          <div className="min-w-0">
            <div className="font-bold truncate">USDT Megadrop</div>
        ...
        <div className="text-right shrink-0">
          ...
          <div className="text-xl font-mono font-bold text-emerald-400 whitespace-nowrap">
            15.2%
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 rounded-lg border border-yellow-400/30 bg-yellow-400/10 px-3 py-2 text-xs text-yellow-300">
        <span>⏰</span>
        <span className="whitespace-nowrap">3 gün 14 saat kaldı</span>
      </div>
