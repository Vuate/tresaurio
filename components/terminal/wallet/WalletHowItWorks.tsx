const steps = [
  {
    ...
    description: "Treasurio continuously scans the blockchain and automatically detects large transfers. Whale wallets, exchange hot wallets, and known addresses are monitored.",
  },
  {
    number: "2",
    title: "Pattern Detection",
    description: "AI-powered algorithm automatically detects 16 different smart money patterns. It captures critical signals such as accumulation, distribution, and pump setups.",
  },
  {
    number: "3",
    title: "Alert & Analysis",
    description: "You receive instant alerts for critical movements. You analyze whale behavior with detailed analysis tools and optimize your trading strategy.",
  },
];
