...
export default function WalletCTA() {
  return (
    <div className="bg-gradient-to-br from-teal-500/10 to-teal-600/5 rounded-3xl p-16 text-center border border-teal-500/30 mt-20">
      {/* CTA Title */}
      <h2 className="text-4xl font-extrabold mb-4">Smart Money'i Takip Edin</h2>

      {/* CTA Description */}
      <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
        Whale hareketlerini gerçek zamanlı izleyin, smart money pattern'lerini
        tespit edin ve piyasada bir adım önde olun.
      </p>
